...
class FunctionsEmulator {
    ...
    createHubServer() {
        ...
        const multicastHandler = (req, res) => {
            ...
            const eventTenantId = (0, functionsEmulatorShared_1.getEventTenantId)(event);
    ...
    async discoverTriggers(emulatableBackend) {
        if (emulatableBackend.predefinedTriggers) {
            ...
            if (emulatableBackend.env?.FIREBASE_KIT_INSTANCE_ID) {
                build.applyKitSecretRefPrefix(discoveredBuild, emulatableBackend.env.FIREBASE_KIT_INSTANCE_ID);
            }
