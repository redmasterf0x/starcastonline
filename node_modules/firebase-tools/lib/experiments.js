...
exports.ALL_EXPERIMENTS = experiments({
    ...
    appcheckadmin: {
        ...
        fullDescription: "Enables the `firebase appcheck:services`, `firebase appcheck:providers` and " +
    ...
    ailogic: {
        ...
        fullDescription: "Enables the `firebase ailogic` command surface for managing Firebase AI Logic, " +
    ...
    secretEnvParams: {
        shortDescription: "Enable writing the backing resource binding for a Functions secret param to .env",
        default: false,
        public: false,
    },
    ...
    extMigrationFeatures: {
        shortDescription: "Enable features intended to assist with the migration of Extension instances to Kits.",
        default: false,
        public: false,
    },
    fdcapimigration: {
